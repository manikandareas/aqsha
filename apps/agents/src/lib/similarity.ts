// Pure string-similarity helpers for citation-integrity matching. Direct port
// of packages/convex/convex/lib/similarity.ts. All scores in [0, 1].
...
// Blended title similarity: token-set Jaccard blended with a normalized
// Levenshtein ratio (typo robust).
