 ...
 * memakainya untuk akses bertipe. Semua nilai runtime → `$env/dynamic/*`, bukan `$env/static/*`.
 */
...
export const PUBLIC_ENV_DEFAULTS = {
	...
	// Origin publik untuk canonical/OG/sitemap. Trailing slash di-strip di konsumen (`lib/seo/config.ts`).
	PUBLIC_SITE_URL: 'https://aqshara.com',
	// Gate index mesin telusur. Default 'false' = preview aman tak ter-index; set 'true' saat cutover.
