...
describe("api-v2 artifacts — auth", () => {
...
describe("api-v2 artifacts — document CRUD round-trip", () => {
  let docId = "";
...
describe("api-v2 artifacts — save URL + cleanup worker", () => {
...
describe("api-v2 artifacts — upload pipeline (live S3/MinIO)", () => {
...
describe("api-v2 artifacts — rate limit (create 20/min)", () => {
