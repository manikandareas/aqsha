...
import { CheckIcon, ChevronRightIcon, CircleIcon } from "@aqsha/ui/icons"
...
function ContextMenuItem({
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      className={cn(
        "group/context-menu-item relative flex cursor-default items-center gap-1.5 rounded-md px-2.5 py-1.5 text-[12px] text-muted-foreground outline-hidden select-none focus:bg-muted/60 focus:text-foreground data-highlighted:bg-muted/60 data-highlighted:text-foreground not-data-[variant=destructive]:focus:**:text-foreground data-inset:pl-7 data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 data-[variant=destructive]:focus:text-destructive dark:data-[variant=destructive]:focus:bg-destructive/20 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5 data-[variant=destructive]:*:[svg]:text-destructive",
        className
      )}
      {...props}
    />
...
function ContextMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-[11px] tracking-widest text-muted-foreground group-focus/context-menu-item:text-foreground",
        className
      )}
      {...props}
    />
