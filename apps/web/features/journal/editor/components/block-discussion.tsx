...
import {
  type TDiscussion,
  discussionPlugin,
} from "@/features/journal/editor/editor/plugins/discussion-kit";
import { suggestionPlugin } from "@/features/journal/editor/editor/plugins/suggestion-kit";
...
export const BlockDiscussion: RenderNodeWrapper<AnyPluginConfig> = (props) => {
  ...
  const resolvedBlockPath: Path = blockPath;
  ...
  const suggestionNodes = [
    ...editor
      ...
      .suggestion.nodes({ at: resolvedBlockPath }),
  ...
  function BlockDiscussionRenderer(
    innerProps: PlateElementProps<TElement, AnyPluginConfig>,
  ) {
    return (
      <BlockCommentContent
