...
function BlockCopyContent({
  ...
  return (
    ...
    >
      ...
      <h3 className="font-heading mt-3 text-3xl font-normal leading-[1.08] tracking-normal text-foreground sm:text-4xl sm:leading-[1.06] lg:text-[2.75rem]">
        {block.title}
      </h3>
      <p
        className={cn(
    ...
    <section id="cara-kerja" className="w-full scroll-mt-[72px] py-24 sm:py-32 lg:py-40">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-heading mt-3 max-w-[min(100%,44rem)] text-[2.5rem] font-normal leading-[1.08] tracking-normal text-foreground sm:mt-4 sm:text-[2.75rem] sm:leading-[1.06] lg:text-[3.25rem] lg:leading-[1.05]">
