    ...
    >
      <div className="relative mx-auto w-full max-w-3xl px-4 sm:px-6">
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <m.h2
            className="font-heading mt-3 text-[2.5rem] font-normal leading-[1.08] tracking-normal text-foreground sm:mt-4 sm:text-[2.75rem] sm:leading-[1.06] lg:text-[3rem] lg:leading-[1.05]"
