  ...
  return (
    <section className="dark w-full bg-background py-32 text-foreground sm:py-40 lg:py-48">
      <div className="mx-auto w-full max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <h2
          ref={headlineRef}
          className="font-heading mx-auto mt-5 max-w-[16ch] text-balance text-5xl font-normal leading-[1.06] tracking-normal text-foreground sm:mt-6 sm:text-6xl sm:leading-[1.05] lg:text-[4.25rem] lg:leading-[1.04]"
        >
