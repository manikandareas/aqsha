...
function PlanReceipt({
  ...
  return (
    <m.div
      className={cn(
        "relative flex flex-col border bg-background pb-8 font-mono",
    ...
    >
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-heading mt-3 text-[2.5rem] font-normal leading-[1.08] tracking-normal text-foreground sm:mt-4 sm:text-[2.75rem] sm:leading-[1.06] lg:text-[3.25rem] lg:leading-[1.05]">
        ...
        <div className="grid gap-y-10 sm:gap-x-10 lg:grid-cols-3 lg:gap-x-12">
          {personas.map((persona, index) => (
            ...
            >
              ...
              <h3 className="font-heading mt-2 text-3xl font-normal leading-tight tracking-normal text-foreground">
                {persona.title}
              </h3>
        ...
        <div id="pricing" className="mt-24 scroll-mt-[72px] sm:mt-32 lg:mt-40">
          <div className="flex flex-wrap items-end justify-between gap-6">
            ...
            >
              ...
              <h3 className="font-heading mt-3 text-[2.25rem] font-normal leading-[1.08] tracking-normal text-foreground sm:mt-4 sm:text-[2.5rem] sm:leading-[1.06] lg:text-[2.75rem] lg:leading-[1.05]">
