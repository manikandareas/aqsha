...
// Contract: base64 decode must produce the exact byte sequence expected by `triggerBase64Download`
// (docx/xlsx exports). A drift here would corrupt downloaded files.
...
describe('base64ToBytes', () => {
	...
	it('round-trips arbitrary binary bytes via charCodeAt encoding', () => {
