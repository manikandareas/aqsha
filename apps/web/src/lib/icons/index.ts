/**
 * Icon boundary for apps/web.
 *
 * Every Aqsha-facing (Lucide-compatible) icon name maps to a Hugeicons glyph.
 * App code (everything except vendored `src/lib/components/ui/**`)
...
// Aqsha name → Hugeicons core-free glyph.
export {
...
/**
 * Shared icon-per-artifact-type mapping. Returns the Hugeicons glyph; render with
