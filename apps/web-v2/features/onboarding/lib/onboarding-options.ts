// Onboarding option sets. The `id` values are the contract with the Convex
// backend (packages/convex/convex/onboarding.ts) — keep them in sync. Labels
// are Bahasa Indonesia, sentence case (never all-uppercase).
