...
export const artifacts = pgTable(
  "artifacts",
  {
    ...
    // Versi konten dokumen authored (sumber Typst proyek): +1 tiap save, guard stale_write.
  ...
  (t) => [
    ...
    check(
      ...
      sql`${t.artifactType} in ('markdown', 'plain_text', 'pdf', 'docx', 'image', 'spreadsheet', 'html', 'svg', 'mermaid', 'json', 'csv', 'code', 'url', 'latex', 'typst')`,
    ),
    check(
