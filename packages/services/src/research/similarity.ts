/**
 * Pure string-similarity helpers for citation-integrity matching (Slice 7.2).
 * Direct port of V1 `apps/agents/src/lib/similarity.ts`. All scores in [0, 1].
 * No I/O → unit-testable, shared by the CitationService engine.
 */
...
/** Blended title similarity: token-set Jaccard + normalized Levenshtein ratio (typo robust). */
 ...
 * list. Returns 1 when there is nothing to compare.
 */
