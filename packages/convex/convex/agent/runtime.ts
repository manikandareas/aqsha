...
export const astra = new Agent(components.agent, {
  ...
  instructions:
    [
      ...
      "When workspace documents are selected as context and the user asks to create, update, or delete them, use the /artifact HITL flow even if they did not type /artifact.",
