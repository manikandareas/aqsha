...
import { uploadArtifactType } from "./model";
import { MAX_UPLOAD_BYTES, MAX_UPLOAD_MB } from "./uploadLimits";
  ...
  if (args.text.trim()) {
    try {
      await ctx.scheduler.runAfter(
        0,
        internal.papers.metadataEnrichment.enrichUploadedPaperMetadata,
        {
          ownerUserId: args.ownerUserId,
          artifactId: args.artifactId,
