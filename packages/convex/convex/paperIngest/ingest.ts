...
import { ARTIFACT_BODY_INLINE_LIMIT } from "../artifactModel";
    ...
    try {
      ...
      if (pdf) {
        ...
        await ctx.scheduler.runAfter(
          0,
          internal.artifactUploads.finalizeStoredArtifact,
          {
            ownerUserId: target.ownerUserId,
            artifactId: args.artifactId,
...
async function writeResolvedMetadata(
  ...
  await ctx.runMutation(internal.paperExtractions.upsertResolvedPaperMetadata, {
    ownerUserId: target.ownerUserId,
    artifactId,
