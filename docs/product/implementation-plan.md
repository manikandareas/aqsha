...
This plan implements the product direction in `docs/product/prd.md`: Aqsha becomes a personal education research workspace with workspace-owned documents, URL artifacts, optional workspace-bound threads, and later thread-level artifact context.
