...
> alasan: `docs/ops/observability/sentry-consolidation-plan.md`. Runbook aktivasi:
> `docs/ops/observability/cicd-runbook.md`. Dokumen ini disimpan hanya sebagai **catatan historis**
...
>
> Dokumen ini = **desain & alasan**. Langkah **menyalakan** (owner): `docs/ops/observability/cicd-runbook.md`.
>
