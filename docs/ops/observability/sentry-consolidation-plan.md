...
1. Rewrite `docs/ops/observability/cicd-runbook.md` agar hanya memuat:
   - CI/CD;
   - Sentry activation, logs, alerts, uptime, dan troubleshooting;
   - Langfuse on-demand;
   - rollback dan quota management.
2. Tandai `docs/ops/observability/cicd-plan.md` sebagai superseded oleh dokumen ini, atau delete setelah
...
4. Update `docs/ops/secrets/infisical-strategy.md`: Dokploy tidak lagi membutuhkan
...
| `docs/ops/observability/cicd-runbook.md` | rewrite | Runbook baru tanpa Grafana/Kuma |
| `docs/ops/observability/cicd-plan.md` | supersede/delete | Tidak menjadi instruksi aktif |
| `docs/ops/secrets/infisical-strategy.md` | edit | Hapus env Grafana/observability profile |
