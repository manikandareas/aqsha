...
> Bagian dari **Phase 2** (§10 [`svelte-plan.md`](svelte-plan.md)).
> Tanggal: 2026-07-14. Melanjutkan [`phase-1-decision-record.md`](phase-1-decision-record.md)
> + [`phase-1-spikes.md`](phase-1-spikes.md) (boundary slice ditulis REAL, di-extend di sini).
...
`/sign-in` tetap scaffolding smoke). Ledger: [`parity-ledger.md`](parity-ledger.md) FND-1..14 = **done**.
