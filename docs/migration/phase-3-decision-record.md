...
> Bagian dari **Phase 3** (§10 [`svelte-plan.md`](svelte-plan.md)).
> Tanggal: 2026-07-14. Melanjutkan [`phase-2-decision-record.md`](phase-2-decision-record.md).
...
onboarding/settings = Phase 5; thread/chat = Phase 6/7). Ledger: [`parity-ledger.md`](parity-ledger.md)
