...
3. Buat `docs/migration/parity-ledger.md` — checklist scope Markdown: route, source/target module, phase, status, notes. Bukan sistem klaim konkuren (eksekusi sequential, satu owner).
