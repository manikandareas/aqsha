...
> Bagian dari **Phase 6** (§10 [`../apps-svelte-migration-plan.md`](../apps-svelte-migration-plan.md)).
...
explore/workspace (Phase 8/9). Ledger: [`apps-svelte-parity-ledger.md`](apps-svelte-parity-ledger.md)
THC-1..9 = **done**.
