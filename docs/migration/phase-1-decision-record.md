...
> Bagian dari **Phase 1** (§10 [`svelte-plan.md`](svelte-plan.md)).
...
[`phase-1-spikes.md`](phase-1-spikes.md) sebagai **OWNER-RUN**.
...
`clerk.auth`; `networkMode:'always'`) di [`phase-1-spikes.md`](phase-1-spikes.md).
