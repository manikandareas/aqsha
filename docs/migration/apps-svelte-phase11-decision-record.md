...
> Bagian dari **Phase 11** (§10 [`../apps-svelte-migration-plan.md`](../apps-svelte-migration-plan.md)).
> Tanggal: 2026-07-15. Melanjutkan Phase 1–9. Bahasa Indonesia; nama package/API/simbol tetap English
> (AGENTS.md). Ledger: [`apps-svelte-parity-ledger.md`](apps-svelte-parity-ledger.md).
