...
Aqsha adalah workspace untuk research dan writing berbantuan AI. Konteks ini menjaga bahasa produk agar landing page, app UI, agent workflow, dan komunikasi marketing memakai istilah yang sama.

## Language

**AI Research and Writing Workspace**:
Ruang kerja untuk menulis, mengelola journal, berdiskusi dengan AI agent, dan menyusun hasil research berbasis evidence.
_Avoid_: Assessment platform, quiz platform, lab assessment platform
...
**Student-Friendly Academic Workspace**:
...
_Avoid_: Library software, citation manager only, casual AI toy
...
**Journal**:
Dokumen kerja panjang yang disimpan di workspace dan dapat dibantu oleh AI untuk drafting, editing, dan revision.
...
- Sebuah **Workspace** memiliki satu atau lebih **Journal**.
...
- **AI Research and Writing Workspace** adalah kategori utama Aqsha; assessment atau quiz bukan kategori utama.
...
- Aqsha harus terasa seperti **Student-Friendly Academic Workspace**: serius soal evidence, tetapi tidak kaku seperti software perpustakaan.
...
- Collaboration Aqsha berarti **Shared Journal** untuk review dan edit akademik, bukan generic team productivity workspace.

## Example dialogue

> **Dev:** "Apakah landing page Aqsha harus menjual quiz generator untuk guru?"
> **Domain expert:** "Tidak. Aqsha harus diposisikan sebagai **AI Research and Writing Workspace** untuk journal, writing, research chat, dan evidence-aware AI assistance."
>
...
> **Domain expert:** "Tidak sepenuhnya. Aqsha harus menjadi **Student-Friendly Academic Workspace**: credible dan evidence-aware, tetapi tetap mudah didekati untuk mahasiswa."
>
...
>
> **Dev:** "Apakah Aqsha collaboration seperti Notion team workspace?"
...
- "Aqsha" pernah dipakai untuk menyebut platform assessment berbasis quiz di marketing site, tetapi kategori produk yang dipilih adalah **AI Research and Writing Workspace**.
...
- Adjacent UX/category reference: OpenNote, because it is closer to AI learning/notebook workspace and student-friendly connected notes, but less direct on academic writing accountability.
...
- Core direction: scholarly workspace + evidence graph.
- Base feel: paper-like neutral, clean academic workspace, document-first.
